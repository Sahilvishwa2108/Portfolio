...
const educationData = [
  {
    ...
    grade: 'CGPA: 8.15/10',
    description: 'Pursuing B.Tech in Computer Science Engineering with focus on modern software development, web technologies, and full-stack development. Building expertise in creating scalable applications and innovative solutions.',
    achievements: [
      'Consistently maintained 8+ CGPA throughout semesters',
      'Developed multiple full-stack projects using MERN stack',
      'Active participant in technical workshops and hackathons',
    ],
    skills: ['React', 'Next.js', 'Node.js', 'MongoDB', 'TypeScript', 'Full Stack Development'],
  ...
  },
  {
    ...
    description: 'Completed Higher Secondary education under CBSE Board with Science stream. Developed strong foundation in Physics, Chemistry, Mathematics, and Computer Science.',
    achievements: [
      'Scored 91.4% in CBSE Board examination',
      'Excelled in Computer Science and Mathematics',
      'Active member of Science Club and Computer Lab activities',
    ],
    skills: ['C++', 'Physics', 'Chemistry', 'Mathematics', 'Problem Solving'],
  ...
  },
  {
    ...
    description: 'Completed Secondary education under CBSE Board with excellent academic performance. Built strong fundamentals in Science, Mathematics, and developed early interest in Computer Science.',
    achievements: [
      'Scored 92.6% in CBSE Board examination',
      'School merit holder with distinction in all subjects',
      'Participated in district-level Science exhibitions',
    ],
    skills: ['Mathematics', 'Science', 'Critical Thinking', 'Academic Excellence'],
