...
const cards = [
  ...
  {
    description: "Cisco AICTE Virtual Internship Program in Cyber Security",
    title: "Cybersecurity Virtual Internship",
    src: "/certificates/ciscoIntern1.png",
    ctaText: "View",
    ctaLink: "https://ui.aceternity.com/templates",
    content: () => {
      return (
  ...
  {
    description: "Campus Ambassador at Physics Wallah",
    title: "Campus Ambassador Certificate",
    src: "/certificates/pwca.png",
    ctaText: "View",
    ctaLink: "https://ui.aceternity.com/templates",
    content: () => {
      return (
